...
import com.riga.bungeon.core.behaviors.InputHandler
import com.riga.bungeon.core.facets.CameraController
import com.riga.bungeon.core.facets.Movable
...
object GameObjectFactory {
	...
	fun newPlayer() = newGameObject(GOPlayer) {
		...
		facets(Movable, CameraController)
	}
}